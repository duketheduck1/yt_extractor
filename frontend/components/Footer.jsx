...
const Footer = () => {
    return (
      <footer id="footer" className="bg-[#121212] border-t border-gray-800 py-8">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-[#AAAAAA] hover:text-white transition duration-150">
              ...
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-[#AAAAAA] hover:text-white transition duration-150">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="mailto:contact@example.com" className="text-[#AAAAAA] hover:text-white transition duration-150">
